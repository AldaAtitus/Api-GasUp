package br.edu.atitus.placa_pai.apisgasup.components;
...
public class JwtUtil {
    private static final String SECRET_KEY = "chaveSuperSecretaParaJWTdeExemplo!@#123"; //Chave para assinar o token
